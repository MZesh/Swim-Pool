            ...
            <div class="card mt-3 ">
                ...
                <table class="table">
                    ...
                    <?php
                            ...
                            FROM users INNER JOIN gala_record ON users.email=gala_record.email WHERE users.email='$email'");
                            $i = 0;
                            ...
                            <tr>
                                <td>Rank: <?php echo $row['position'];?></td>
                                <td>Sport: <?php echo $row['sport'];?></td>
